    ...
    <header className="sticky top-0 z-30 bg-stone-900/95 backdrop-blur-md text-stone-100 border-b border-stone-800 shadow-md">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 h-15 sm:h-16 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          {/* Language selector */}
          <div className="relative flex items-center bg-stone-800/90 border border-stone-700/70 rounded-lg px-2 py-1.5 min-h-[38px] text-xs">
            ...
            <select
              ...
              className="bg-transparent text-stone-200 text-xs font-medium focus:outline-none cursor-pointer pr-1 max-w-[70px] sm:max-w-none"
            >
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 min-h-[38px] min-w-[38px] px-2.5 sm:px-3 py-1.5 rounded-lg bg-stone-800 hover:bg-stone-700 active:scale-95 text-stone-200 text-xs font-medium transition-all border border-stone-700/60"
